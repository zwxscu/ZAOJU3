...
{
    public partial class ProduceReccordView : BaseChildView
    {
        #region 数据
        ...
        #endregion
        public ProduceReccordView(string captionText)
            : base(captionText)
        {
            InitializeComponent();
        ...
        public void RefreshQueryContent(DataTable dt)
        {
            ...
            else
            {
                ...
                this.dataGridView1.Columns["produceRecordID"].HeaderText = "记录序号";
                this.dataGridView1.Columns["productBarcode"].HeaderText = "主机条码";
                this.dataGridView1.Columns["inputTime"].HeaderText = "投产时间";
                this.dataGridView1.Columns["outputTime"].HeaderText = "下线时间";
